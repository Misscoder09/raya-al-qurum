...
const downloadSalesOffer = async () => {
  try {
    const response = await fetch(
      "/images/Residences/f12-1bhk-sales-offer.jpg"
    );

    if (!response.ok) {
      throw new Error("F12 Sales offer file not found");
    }
    ...
    link.href = url;
    link.download = "Raya-Al-Qurum-F12-1BHK-Sales-Offer.jpg";
    ...
    console.error("F12 Sales offer download failed:", error);
  }
};
...
export default function F8OneBHK() {
  const residence = {
    ...
    // F12 images
    unitLayout: "/images/Residences/F12-1BHK-unit-layout.png",
    layoutDetails: "/images/Residences/F12-1BHK-layout-details.png",
  };
        ...
        <div className="sales-offer-inner">
          ...
          <div className="sales-offer-content">
            ...
            <p className="sales-offer-intro">
              Discover the F12 · 1 BHK residence, thoughtfully planned
            ...
            <div className="sales-offer-info">
              ...
              <div className="sales-info-item">
                <span>UNIT TYPE</span>
                <strong>F12 · 1 BHK</strong>
              </div>

              <div className="sales-info-item">
                <span>UNIT AREA</span>
                <strong>86.85 m²</strong>
              </div>
            ...
            <p className="sales-download-note">
              Download the F12 · 1 BHK sales offer
            </p>
          ...
          <div className="sales-offer-visual">
            ...
            <img
              ...
              src="/images/Residences/f12-1bhk-sales-offer.jpg"
              alt="F12 1 BHK Sales Offer"
            />
